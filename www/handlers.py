...
async def index(request):
    ...
    blogs = [
        Blog(id='1', name='Test Blog', summary=summary,content=summary, created_at=time.time() - 120),
        Blog(id='2', name='Something New', summary=summary, content=summary,created_at=time.time() - 3600),
        Blog(id='3', name='Learn Swift', summary=summary, content=summary,created_at=time.time() - 7200)
    ]
    # for blog in blogs:
    #     await blog.save()
    return {
...
def manage_create_blog():
    return {
        '__template__': 'manage_blog_edit01.html',
        'id': '',
        'action': '/api/blogs'
    }
...
async def api_register_user(*, email, name, passwd):
    ...
    user = User(id=uid, name=name.strip(), email=email, admin=0,
